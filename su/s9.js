...
sb = JSON.parse(localStorage.getItem('sb9') || '[]'),
dataArr = JSON.parse(localStorage.getItem('st9') || '[]');
var sn = localStorage.getItem("mn9");
...
function backme() {
var DOMToSerach = document.querySelector("#backm");
DOMToSerach.innerText="backme"
var text = DOMToSerach.innerText || "";
var isStringFound = text.indexOf("backme") > -1;
if (isStringFound === true) {
