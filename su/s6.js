...
sb=JSON.parse(localStorage.getItem('sb6')||'[]'),
dataArr = JSON.parse(localStorage.getItem('st6') || '[]');
var sn=localStorage.getItem("mn6");
...
function subform(){
    ...
    localStorage.setItem('sb6',JSON.stringify(sb));
...
var sum = parseFloat(mark1)+parseFloat(mark2)+parseFloat(mark3)+parseFloat(mark4)+parseFloat(mark5)+parseFloat(mark6);
	...
	newRow.insertCell().innerHTML = `<a onClick="update(this)" style=""class=" midle-success">&#9998;<i class="fas fa-times"></i></a>` // newRow.insertCell().innerHTML = `<a onClick="addmark(this)"><button ><a href="mark.html">add mark</a></button><i class="fas fa-times"></i></a>`
