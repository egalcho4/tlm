...
sb=JSON.parse(localStorage.getItem('sb7')||'[]'),
dataArr = JSON.parse(localStorage.getItem('st7') || '[]');
var sn=localStorage.getItem("mn7");
...
function subform(){
    ...
    localStorage.setItem('sb7',JSON.stringify(sb));
...
dataArr.forEach(row=> {
	...
	chexam1.addEventListener('click', ()=> {
...
var sum = parseFloat(mark1)+parseFloat(mark2)+parseFloat(mark3)+parseFloat(mark4)+parseFloat(mark5)+parseFloat(mark6);
	...
	newRow.insertCell().innerHTML = `<a onClick="update(this)" style="" class=" text-success">&#9998;<i class="fas fa-times"></i></a>` // newRow.insertCell().innerHTML = `<a onClick="addmark(this)"><button ><a href="mark.html">add mark</a></button><i class="fas fa-times"></i></a>`
...
if(vldate()){
	...
	var sum = parseFloat(myForm.mark1.value)+parseFloat(myForm.mark2.value)+parseFloat(myForm.mark3.value)+parseFloat(myForm.mark4.value)+parseFloat(myForm.mark5.value)+parseFloat(myForm.mark6.value)+parseFloat(myForm.mark7.value)+parseFloat(myForm.mark8.value)+parseFloat(myForm.mark9.value)+parseFloat(myForm.mark10.value)+parseFloat(myForm.mark11.value)+parseFloat(myForm.mark12.value );
		...
		newRow.insertCell().textContent = sum;
			...
			newRow.insertCell().innerHTML = `<a onClick="update(this)" class=" text-success">&#9998;<i class="fas fa-times"></i></a>` // newRow.insertCell().innerHTML = `<a onClick="addmark(this)"><button ><a href="mark.html">add mark</a></button><i class="fas fa-times"></i></a>`
...
function update(td) {
	...
	var midlename= document.querySelector('.midle').value;
     ...
     +parseFloat(mark6)+parseFloat(mark7)+parseFloat(mark8)+parseFloat(mark8)+parseFloat(mark9)+parseFloat(mark10)+parseFloat(mark11)+parseFloat(mark12);
		...
		var id=dat.id;
		var left=dat.left;
		dataArr[index] = {left,id,sum,av,firstname,lastname,midlename,sid,age,gender, mark1, mark2, mark3, mark4, mark5, mark6, mark7, mark8, mark9, mark10, mark11, mark12};
