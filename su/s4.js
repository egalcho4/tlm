...
sb = JSON.parse(localStorage.getItem('sb4') || '[]'),
dataArr = JSON.parse(localStorage.getItem('st4') || '[]');
var sn = localStorage.getItem("mn4");
...
function update(td) {
	...
	var index = row.rowIndex - 1;
	var dat = dataArr[index];
	var firstname = document.querySelector('.inputNL');
	firstname.setAttribute("value", dat.firstname);
