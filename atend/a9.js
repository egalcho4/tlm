...
sn=localStorage.getItem("mn9"),
at=JSON.parse(localStorage.getItem('st9')||'[]');
...
function onformsubmit() {
		...
		if (selectedRow == null) {
	        ...
	        newRow.insertCell().innerHTML = `<a onClick="absent(this)" class="btn btn-success" style="bafckground-color:green">absent<i class="fas fa-times"></i></a>` // newRow.insertCell().innerHTML = `<a onClick="addmark(this)"><button ><a href="mark.html">add mark</a></button><i class="fas fa-times"></i></a>`
