...
sn=localStorage.getItem("mn4"),
at=JSON.parse(localStorage.getItem('st4')||'[]');
...
var sum=parseFloat(mark1)+parseFloat(mark2)+parseFloat(mark3)+parseFloat(mark4)+parseFloat(mark5)
     +parseFloat(mark6)+parseFloat(mark7)+parseFloat(mark8)+parseFloat(mark8)+parseFloat(mark9)+parseFloat(mark10)+parseFloat(mark11)+parseFloat(mark12);
		var av=sum/sn;
	var no=b.no;
	at[index]={sum,no,left,av,firstname,lastname,sid,age,midlename,gender,id,mark1,mark2,mark3,mark4,mark5,mark6,mark7,mark8,mark9,mark10,mark11,mark12}
