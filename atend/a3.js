...
dataArr = JSON.parse(localStorage.getItem('st3') || '[]'),
ad=localStorage.getItem("dtn"),
sn=localStorage.getItem("mn3"),
at=JSON.parse(localStorage.getItem('st3')||'[]');
...
var sum=parseFloat(mark1)+parseFloat(mark2)+parseFloat(mark3)+parseFloat(mark4)+parseFloat(mark5)
	...
	at[index]={left,av,firstname,lastname,sid,age,midlename,gender,id,mark1,mark2,mark3,mark4,mark5,mark6,mark7,mark8,mark9,mark10,mark11,mark12}
