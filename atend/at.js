...
sn=localStorage.getItem("mn"),
at=JSON.parse(localStorage.getItem('dataArr')||'[]');
...
at.forEach(row=> {
    ...
    newRow.insertCell().innerHTML = `<a onClick="update(this)" class="btn btn-success" style="background-color:green">&#9998;<i class="fas fa-times"></i></a>` // newRow.insertCell().innerHTML = `<a onClick="addmark(this)"><button ><a href="mark.html">add mark</a></button><i class="fas fa-times"></i></a>`
